...
public class ConnNet {
    ...
    public HttpURLConnection getConn(String urlpath) {
        String finalurl = "http://192.168.1.243:8080/fashion_server/" + urlpath;
    ...
    public HttpPost gethttPost(String uripath) {
        ...
        HttpPost httpPost = new HttpPost("http://192.168.1.243:8080/fashion_server/" + uripath);
        System.out.println("http://192.168.1.243:8080/fashion_server/" + uripath);
        return httpPost;
    }
}